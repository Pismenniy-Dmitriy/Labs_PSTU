...
int Graph<T>::Dijkstra(T& startVertex)
{
	...
	{
		cout << "Shortest distance from the vertex  " << startVertex << " to the vertex " << vertList[i] << " is " << labelList[GetVertPos(vertList[i])] << endl;
	}
...
Graph<int> makeGraph()
{
	...
	cout << "Number of vertices? "; cin >> amountVerts; cout << endl; 
	cout << "Number of edges? "; cin >> amountEdges; cout << endl; 
	...
	for (int i = 0; i < amountEdges; ++i) {
		cout << "Source vertex: "; cin >> sourceVertex; cout << endl; 
		int* sourceVertPtr = &sourceVertex; 
		cout << "Final vertex: "; cin >> targetVertex; cout << endl; 
		int* targetVertPtr = &targetVertex; 

		cout << "Weight of edge: "; cin >> edgeWeight; cout << endl; 
...
void Graph<T>::InsertEdge(const T& vertex1, const T& vertex2, int weight) {
	if (this->GetVertPos(vertex1) != (-1) && this->GetVertPos(vertex2) != (-1)) {
		...
		if (this->adjMatrix[vertPos1][vertPos2] != 0
			...
			cout << "An edge between the vertices is already there" << endl;
			return;
		}
		else {
